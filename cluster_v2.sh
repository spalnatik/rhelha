...
if [[ "$version" =~ ^7[._][0-9] || "$offersap" =~ ^7[0-9][sap*] ]]; then
    ...
    --name customScript \
    --publisher Microsoft.Azure.Extensions \
    --protected-settings "{\"fileUris\": [\"https://raw.githubusercontent.com/spalnatik/rhelha/main/fc7.sh\"],\"commandToExecute\": \"./fc7.sh $rgname $subscriptionID \"}" >> $logfile
    ...
    --name customScript \
    --publisher Microsoft.Azure.Extensions \
    --protected-settings "{\"fileUris\": [\"https://raw.githubusercontent.com/spalnatik/rhelha/main/fenceconfig.sh\"],\"commandToExecute\": \"./fenceconfig.sh $rgname $subscriptionID \"}" >> $logfile
